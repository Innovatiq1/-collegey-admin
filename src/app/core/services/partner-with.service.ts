...
export class PartnerWithService {
  constructor(private http: HttpClient) {}

    createTheamData = (data: any): Observable<any> => {
    const apiUrl = environment.apiUrl + 'admin/collegeyWithPartner/addData';
  ...
  getAllData = (data: any): Observable<any> => {
    const apiUrl = environment.apiUrl + 'admin/collegeyWithPartner/getAllData';
  ...
  updateTheamData = (data: any, Id: any): Observable<any> => {
    let apiUrl = environment.apiUrl + 'admin/collegeyWithPartner/updateData/' + Id;
