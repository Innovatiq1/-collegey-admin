...
export class FundInService {
  constructor(private http: HttpClient) {}

  createTheamData = (data: any): Observable<any> => {
    const apiUrl = environment.apiUrl + 'admin/collegeyInFund/addData';
  ...
  getAllData = (data: any): Observable<any> => {
    const apiUrl = environment.apiUrl + 'admin/collegeyInFund/getAllData';
  ...
  updateTheamData = (data: any, Id: any): Observable<any> => {
    let apiUrl = environment.apiUrl + 'admin/collegeyInFund/updateData/' + Id;
