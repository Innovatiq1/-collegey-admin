...
// Componets
import { AgreementTermsConditionComponent } from '../../mentor/agreement-terms-condition/agreement-terms-condition.component';
...
@Component({
  ...
  styleUrls: ['./agreement-terms.component.css']
})
