...
@Component({
  selector: 'app-list-mentorfile',
  templateUrl: './list-mentorfile.component.html',
  styleUrls: ['./list-mentorfile.component.css']
})
export class ListMentorfileComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      nzTitle: mode === "Create" ? "Create Mentor file" : "Update Mentor file",
      nzContent: AddMentorfileComponent,
      nzFooter: [
        {
  ...
  deleteMentorFile(listid: any) {
    if (confirm("Are you sure to delete this file")) {
      var mylist = { id: listid };
      this.mentorService.deleteMentorFile(mylist).subscribe(
        (response) => {
