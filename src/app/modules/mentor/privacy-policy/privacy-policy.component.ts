...
export class PrivacyPolicyComponent implements OnInit {
  ...
  getPrivacy(filters) {
    ...
    this.mentorService.getPrivacyList(filters).subscribe(response => {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      nzTitle: mode === "Create" ? "Create Privacy Policy" : "Update Privacy Policy",
      nzContent: AddPrivacyPolicyComponent,
      nzFooter: [
        {
