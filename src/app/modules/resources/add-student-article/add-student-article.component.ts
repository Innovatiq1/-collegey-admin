...
@Component({
  selector: 'app-add-student-article',
  templateUrl: './add-student-article.component.html',
  styleUrls: ['./add-student-article.component.css']
})
export class AddStudentArticleComponent implements OnInit {
  ...
  fetchResource() {
    let obj = {id:this.id}
    this.studentService.getStudentArticleInfo(obj).subscribe(
      (response) => {
        if (response) {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.resourceForm.valid) {
        if (this.mode === Mode.Create) {
          ...
          this.studentService.createStudentArticle(this.resourceForm.value).subscribe(
            (res) => {
              this.id = res._id;
              this.modal.destroy();
              resolve();
