...
@Component({
  selector: 'app-add-college-review',
  templateUrl: './add-college-review.component.html',
  styleUrls: ['./add-college-review.component.css']
})
export class AddCollegeReviewComponent implements OnInit {
