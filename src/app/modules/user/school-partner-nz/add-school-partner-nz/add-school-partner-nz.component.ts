...
@Component({
  selector: 'app-add-school-partner-nz',
  templateUrl: './add-school-partner-nz.component.html',
  styleUrls: ['./add-school-partner-nz.component.css']
})
export class AddSchoolPartnerNzComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<AddSchoolPartnerNzComponent>,
  ...
  addBlog(formObj):any {
    return new Promise((resolve, reject) => {
      this.schoolService.saveSchool(formObj).subscribe(
        (response) => {
  ...
  updateBlog(obj):any {
    return new Promise((resolve, reject) => {
      this.schoolService.updateSchool(obj, this.mentor._id).subscribe(
        (response) => {
          this.isLoading = false;
          Swal.fire({
            title: 'Successful',
...
@NgModule({
  declarations: [AddSchoolPartnerNzComponent],
  imports: [
    CommonModule,
    MaterialModule,
    SharedModule,
...
class AddSchoolPartnerNzModule { }
