...
@Component({
  selector: 'app-add-university-partner-nz',
  templateUrl: './add-university-partner-nz.component.html',
  styleUrls: ['./add-university-partner-nz.component.css']
})
export class AddUniversityPartnerNzComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<AddUniversityPartnerNzComponent>,
  ...
  addBlog(formObj):any {
    return new Promise((resolve, reject) => {
      this.universityService.saveUniversity(formObj).subscribe(
        (response) => {
  ...
  updateBlog(obj):any {
    return new Promise((resolve, reject) => {
      this.universityService.updateUniversity(obj, this.mentor._id).subscribe(
        (response) => {
          this.isLoading = false;
          Swal.fire({
            title: 'Successful',
...
@NgModule({
  declarations: [AddUniversityPartnerNzComponent],
  imports: [
    CommonModule,
    MaterialModule,
    SharedModule,
...
class AddUniversityPartnerNzModule { }
