...
@Component({
  selector: 'app-add-project-refferal-invite',
  templateUrl: './add-project-refferal-invite.component.html',
  styleUrls: ['./add-project-refferal-invite.component.css']
})
export class AddProjectRefferalInviteComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["project_refferal_Invite_template", [Validators.required]],
