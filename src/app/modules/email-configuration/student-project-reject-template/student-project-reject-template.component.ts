...
@Component({
  selector: 'app-student-project-reject-template',
  templateUrl: './student-project-reject-template.component.html',
  styleUrls: ['./student-project-reject-template.component.css']
})
export class StudentProjectRejectTemplateComponent implements OnInit {
  ...
  getForgetPasswordTemplate(filters) {
    ...
    this.emailConfigurationService.getForgetPasswordTemplate(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.student_project_reject_template;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddStudentProjectRejectTemplateComponent,
      nzFooter: [
        {
