...
@Component({
  selector: 'app-add-free-project-joiningg',
  templateUrl: './add-free-project-joiningg.component.html',
  styleUrls: ['./add-free-project-joiningg.component.css']
})
export class AddFreeProjectJoininggComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["free_project_Joining_template", [Validators.required]],
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.emailTemplateForm.valid) {
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'free_project_Joining_template';
