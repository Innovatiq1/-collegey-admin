...
@Component({
  selector: 'app-add-new-waitlist',
  templateUrl: './add-new-waitlist.component.html',
  styleUrls: ['./add-new-waitlist.component.css']
})
export class AddNewWaitlistComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["new_waitlist_template", [Validators.required]],
