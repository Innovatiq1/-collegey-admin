...
@Component({
  selector: 'app-view-mentor-project-invite',
  templateUrl: './view-mentor-project-invite.component.html',
  styleUrls: ['./view-mentor-project-invite.component.css']
})
export class ViewMentorProjectInviteComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddMentorProjectInviteComponent,
      nzFooter: [
        {
