...
@Component({
  selector: 'app-add-send-project-invoice',
  templateUrl: './add-send-project-invoice.component.html',
  styleUrls: ['./add-send-project-invoice.component.css']
})
export class AddSendProjectInvoiceComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["send_project_invoice_template", [Validators.required]],
