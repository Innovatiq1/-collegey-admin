...
@Component({
  selector: 'app-view-completed-project-template',
  templateUrl: './view-completed-project-template.component.html',
  styleUrls: ['./view-completed-project-template.component.css']
})
export class ViewCompletedProjectTemplateComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddCompletedProjectTemplateComponent,
      nzFooter: [
        {
