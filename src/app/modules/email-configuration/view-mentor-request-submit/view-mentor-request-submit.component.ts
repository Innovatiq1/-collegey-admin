...
@Component({
  selector: 'app-view-mentor-request-submit',
  templateUrl: './view-mentor-request-submit.component.html',
  styleUrls: ['./view-mentor-request-submit.component.css']
})
export class ViewMentorRequestSubmitComponent implements OnInit {
  ...
  getForgetPasswordTemplate(filters) {
    ...
    this.emailConfigurationService.getForgetPasswordTemplate(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.mentor_request_submit_template;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddMentorRequestSubmitComponent,
      nzFooter: [
        {
