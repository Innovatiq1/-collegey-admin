...
@Component({
  selector: 'app-view-invite-user-reject-template',
  templateUrl: './view-invite-user-reject-template.component.html',
  styleUrls: ['./view-invite-user-reject-template.component.css']
})
export class ViewInviteUserRejectTemplateComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddInviteUserRejectTemplateComponent,
      nzFooter: [
        {
