...
@Component({
  selector: 'app-view-mentor-request-template',
  templateUrl: './view-mentor-request-template.component.html',
  styleUrls: ['./view-mentor-request-template.component.css']
})
export class ViewMentorRequestTemplateComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddMentorRequestTemplateComponent,
      nzFooter: [
        {
