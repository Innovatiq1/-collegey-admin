...
@Component({
  selector: 'app-add-new-project-template',
  templateUrl: './add-new-project-template.component.html',
  styleUrls: ['./add-new-project-template.component.css']
})
export class AddNewProjectTemplateComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["new_project_add_template", [Validators.required]],
