...
@Component({
  selector: 'app-add-member-reffered-template',
  templateUrl: './add-member-reffered-template.component.html',
  styleUrls: ['./add-member-reffered-template.component.css']
})
export class AddMemberRefferedTemplateComponent implements OnInit {
