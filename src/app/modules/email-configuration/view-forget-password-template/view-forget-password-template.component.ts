...
@Component({
  selector: 'app-view-forget-password-template',
  templateUrl: './view-forget-password-template.component.html',
  styleUrls: ['./view-forget-password-template.component.css']
})
export class ViewForgetPasswordTemplateComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddForgetPasswordTemplateComponent,
      nzFooter: [
        {
