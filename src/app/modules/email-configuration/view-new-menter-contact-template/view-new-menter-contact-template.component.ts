...
@Component({
  selector: 'app-view-new-menter-contact-template',
  templateUrl: './view-new-menter-contact-template.component.html',
  styleUrls: ['./view-new-menter-contact-template.component.css']
})
export class ViewNewMenterContactTemplateComponent implements OnInit {
  ...
  getForgetPasswordTemplate(filters) {
    ...
    this.emailConfigurationService.getForgetPasswordTemplate(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.new_mentor_contact_template;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddNewMenterContactTemplateComponent,
      nzFooter: [
        {
