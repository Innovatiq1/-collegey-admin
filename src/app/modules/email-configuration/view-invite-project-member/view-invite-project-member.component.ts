...
@Component({
  selector: 'app-view-invite-project-member',
  templateUrl: './view-invite-project-member.component.html',
  styleUrls: ['./view-invite-project-member.component.css']
})
export class ViewInviteProjectMemberComponent implements OnInit {
  ...
  getForgetPasswordTemplate(filters) {
    ...
    this.emailConfigurationService.getForgetPasswordTemplate(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.invite_project_member_template;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddInviteProjectMemberComponent,
      nzFooter: [
        {
