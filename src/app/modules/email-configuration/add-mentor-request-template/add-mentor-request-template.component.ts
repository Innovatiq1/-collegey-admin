...
@Component({
  selector: 'app-add-mentor-request-template',
  templateUrl: './add-mentor-request-template.component.html',
  styleUrls: ['./add-mentor-request-template.component.css']
})
export class AddMentorRequestTemplateComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["new_mentor_request_template", [Validators.required]],
