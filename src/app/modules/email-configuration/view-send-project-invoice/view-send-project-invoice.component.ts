...
@Component({
  selector: 'app-view-send-project-invoice',
  templateUrl: './view-send-project-invoice.component.html',
  styleUrls: ['./view-send-project-invoice.component.css']
})
export class ViewSendProjectInvoiceComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddSendProjectInvoiceComponent,
      nzFooter: [
        {
