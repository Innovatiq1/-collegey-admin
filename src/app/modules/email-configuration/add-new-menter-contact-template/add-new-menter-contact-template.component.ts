...
@Component({
  selector: 'app-add-new-menter-contact-template',
  templateUrl: './add-new-menter-contact-template.component.html',
  styleUrls: ['./add-new-menter-contact-template.component.css']
})
export class AddNewMenterContactTemplateComponent implements OnInit {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.emailTemplateForm.valid) {
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'new_mentor_contact_template';
