...
@Component({
  selector: 'app-add-student-project-approval-template',
  templateUrl: './add-student-project-approval-template.component.html',
  styleUrls: ['./add-student-project-approval-template.component.css']
})
export class AddStudentProjectApprovalTemplateComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["student_project_approval_template", [Validators.required]],
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.emailTemplateForm.valid) {
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'student_project_approval_template';
