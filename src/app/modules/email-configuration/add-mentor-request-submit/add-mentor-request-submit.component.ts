...
@Component({
  selector: 'app-add-mentor-request-submit',
  templateUrl: './add-mentor-request-submit.component.html',
  styleUrls: ['./add-mentor-request-submit.component.css']
})
export class AddMentorRequestSubmitComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["mentor_request_submit_template", [Validators.required]],
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.emailTemplateForm.valid) {
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'mentor_request_submit_template';
