...
@Component({
  selector: 'app-student-project-approval-template',
  templateUrl: './student-project-approval-template.component.html',
  styleUrls: ['./student-project-approval-template.component.css']
})
export class StudentProjectApprovalTemplateComponent implements OnInit {
  ...
  getForgetPasswordTemplate(filters) {
    ...
    this.emailConfigurationService.getForgetPasswordTemplate(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.student_project_approval_template;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddStudentProjectApprovalTemplateComponent,
      nzFooter: [
        {
