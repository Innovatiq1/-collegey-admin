...
@Component({
  selector: 'app-view-new-waitlist',
  templateUrl: './view-new-waitlist.component.html',
  styleUrls: ['./view-new-waitlist.component.css']
})
export class ViewNewWaitlistComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddNewWaitlistComponent,
      nzFooter: [
        {
