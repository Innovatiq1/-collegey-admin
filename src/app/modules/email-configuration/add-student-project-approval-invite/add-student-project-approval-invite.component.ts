...
@Component({
  selector: 'app-add-student-project-approval-invite',
  templateUrl: './add-student-project-approval-invite.component.html',
  styleUrls: ['./add-student-project-approval-invite.component.css']
})
export class AddStudentProjectApprovalInviteComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["student_project_approval_Invite_template", [Validators.required]],
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.emailTemplateForm.valid) {
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'student_project_approval_Invite_template';
