...
@Component({
  selector: 'app-view-welcome-mail-template',
  templateUrl: './view-welcome-mail-template.component.html',
  styleUrls: ['./view-welcome-mail-template.component.css']
})
export class ViewWelcomeMailTemplateComponent implements OnInit {
  modal: NzModalRef;
  Mode = Mode;
  isLoading = false;
  assignData = [];
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddWelcomeMailTemplateComponent,
      nzFooter: [
        {
