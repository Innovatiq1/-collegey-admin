...
@Component({
  selector: 'app-add-invite-new-project-member',
  templateUrl: './add-invite-new-project-member.component.html',
  styleUrls: ['./add-invite-new-project-member.component.css']
})
export class AddInviteNewProjectMemberComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["invite_new_project_member_template", [Validators.required]],
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.emailTemplateForm.valid) {
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'invite_new_project_member_template';
