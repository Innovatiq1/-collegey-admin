...
@Component({
  selector: 'app-view-member-reffered-template',
  templateUrl: './view-member-reffered-template.component.html',
  styleUrls: ['./view-member-reffered-template.component.css']
})
export class ViewMemberRefferedTemplateComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddMemberRefferedTemplateComponent,
      nzFooter: [
        {
