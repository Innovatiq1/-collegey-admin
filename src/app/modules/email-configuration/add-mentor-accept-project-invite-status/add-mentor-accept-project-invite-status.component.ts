...
@Component({
  selector: 'app-add-mentor-accept-project-invite-status',
  templateUrl: './add-mentor-accept-project-invite-status.component.html',
  styleUrls: ['./add-mentor-accept-project-invite-status.component.css']
})
export class AddMentorAcceptProjectInviteStatusComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["mentor_accept_project_invite_status_template", [Validators.required]],
