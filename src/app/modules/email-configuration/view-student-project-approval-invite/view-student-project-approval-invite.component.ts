...
@Component({
  selector: 'app-view-student-project-approval-invite',
  templateUrl: './view-student-project-approval-invite.component.html',
  styleUrls: ['./view-student-project-approval-invite.component.css']
})
export class ViewStudentProjectApprovalInviteComponent implements OnInit {
  ...
  getForgetPasswordTemplate(filters) {
    ...
    this.emailConfigurationService.getForgetPasswordTemplate(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.student_project_approval_Invite_template;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddStudentProjectApprovalInviteComponent,
      nzFooter: [
        {
