...
@Component({
  selector: 'app-add-completed-project-template',
  templateUrl: './add-completed-project-template.component.html',
  styleUrls: ['./add-completed-project-template.component.css']
})
export class AddCompletedProjectTemplateComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["completed_project_template", [Validators.required]],
