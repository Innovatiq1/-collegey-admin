...
@Component({
  selector: 'app-add-student-project-reject-template',
  templateUrl: './add-student-project-reject-template.component.html',
  styleUrls: ['./add-student-project-reject-template.component.css']
})
export class AddStudentProjectRejectTemplateComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["student_project_reject_template", [Validators.required]],
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.emailTemplateForm.valid) {
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'student_project_reject_template';
