...
@Component({
  selector: 'app-view-new-invitation-friend',
  templateUrl: './view-new-invitation-friend.component.html',
  styleUrls: ['./view-new-invitation-friend.component.css']
})
export class ViewNewInvitationFriendComponent implements OnInit {
  ...
  getForgetPasswordTemplate(filters) {
    ...
    this.emailConfigurationService.getForgetPasswordTemplate(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.new_invite_Friend_template;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddNewInvitationFriendComponent,
      nzFooter: [
        {
