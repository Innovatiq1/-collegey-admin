...
@Component({
  selector: 'app-add-admin-email',
  templateUrl: './add-admin-email.component.html',
  styleUrls: ['./add-admin-email.component.css']
})
export class AddAdminEmailComponent implements OnInit {
