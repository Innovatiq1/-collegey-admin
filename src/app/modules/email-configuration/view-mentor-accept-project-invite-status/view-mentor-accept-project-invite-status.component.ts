...
@Component({
  selector: 'app-view-mentor-accept-project-invite-status',
  templateUrl: './view-mentor-accept-project-invite-status.component.html',
  styleUrls: ['./view-mentor-accept-project-invite-status.component.css']
})
export class ViewMentorAcceptProjectInviteStatusComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddMentorAcceptProjectInviteStatusComponent,
      nzFooter: [
        {
