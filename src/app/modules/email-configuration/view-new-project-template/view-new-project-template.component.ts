...
@Component({
  selector: 'app-view-new-project-template',
  templateUrl: './view-new-project-template.component.html',
  styleUrls: ['./view-new-project-template.component.css']
})
export class ViewNewProjectTemplateComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddNewProjectTemplateComponent,
      nzFooter: [
        {
