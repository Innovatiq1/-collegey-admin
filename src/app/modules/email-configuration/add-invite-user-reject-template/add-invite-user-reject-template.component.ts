...
@Component({
  selector: 'app-add-invite-user-reject-template',
  templateUrl: './add-invite-user-reject-template.component.html',
  styleUrls: ['./add-invite-user-reject-template.component.css']
})
export class AddInviteUserRejectTemplateComponent implements OnInit {
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["invite_user_reject_template", [Validators.required]],
