...
@Component({
  selector: 'app-view-admin-email',
  templateUrl: './view-admin-email.component.html',
  styleUrls: ['./view-admin-email.component.css']
})
export class ViewAdminEmailComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      nzTitle: mode === "Create" ? "Create New" : "Admin New Email Template",
      nzContent: AddAdminEmailComponent,
      nzFooter: [
        {
