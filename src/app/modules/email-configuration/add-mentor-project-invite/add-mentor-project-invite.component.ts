...
@Component({
  selector: 'app-add-mentor-project-invite',
  templateUrl: './add-mentor-project-invite.component.html',
  styleUrls: ['./add-mentor-project-invite.component.css']
})
export class AddMentorProjectInviteComponent implements OnInit {    
  ...
  createForm() {
    this.emailTemplateForm = this.fb.group(
      {
        email_template_type: ["mentor_project_invite_template", [Validators.required]],
