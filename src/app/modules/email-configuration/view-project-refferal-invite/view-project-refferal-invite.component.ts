...
@Component({
  selector: 'app-view-project-refferal-invite',
  templateUrl: './view-project-refferal-invite.component.html',
  styleUrls: ['./view-project-refferal-invite.component.css']
})
export class ViewProjectRefferalInviteComponent implements OnInit {
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddProjectRefferalInviteComponent,
      nzFooter: [
        {
