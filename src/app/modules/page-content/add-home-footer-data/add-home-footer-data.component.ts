...
@Component({
  selector: 'app-add-home-footer-data',
  templateUrl: './add-home-footer-data.component.html',
  styleUrls: ['./add-home-footer-data.component.css']
})
export class AddHomeFooterDataComponent implements OnInit {
  ...
  patchForm(pageContent) {
    ...
    this.pageContentForm.patchValue({
      address1: pageContent?.address1,
      address1email: pageContent?.address1email,
      address1phone: pageContent?.address1phone,
      address2: pageContent?.address2,
      address2email: pageContent?.address2email,
      address2phone: pageContent?.address2phone,
      copyright: pageContent?.copyright,
    });
    ...
    this.pageContentForm = this.fb.group(
      {
        ...
        address1email: ["", [Validators.required]],
        address1phone: ["", [Validators.required]],
        address2: ["", [Validators.required]],
        address2email: ["", [Validators.required]],
        address2phone: ["", [Validators.required]],
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.pageContentForm.valid) {
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'home_footer_section';
