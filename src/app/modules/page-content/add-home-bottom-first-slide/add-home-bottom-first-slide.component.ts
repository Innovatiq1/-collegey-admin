...
@Component({
  selector: 'app-add-home-bottom-first-slide',
  templateUrl: './add-home-bottom-first-slide.component.html',
  styleUrls: ['./add-home-bottom-first-slide.component.css']
})
export class AddHomeBottomFirstSlideComponent implements OnInit {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.pageContentForm.valid) {
        ...
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'home_bottom_slide_01';
