...
@Component({
  selector: 'app-view-home-fourth-sec',
  templateUrl: './view-home-fourth-sec.component.html',
  styleUrls: ['./view-home-fourth-sec.component.css']
})
export class ViewHomeFourthSecComponent implements OnInit {
  ...
  getHomeFirstSecData(filters) {
    ...
    this.pageContentService.getHomeFirstSecData(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.home_fourth_sec_data;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddHomeFourthSecComponent,
      nzFooter: [
        {
  ...
  deleteHome(index: any) {
    if (confirm("Are you sure to delete this item")) {
      ...
      var deletelist = { index: index, filedName: "home_fourth_sec_data" };
