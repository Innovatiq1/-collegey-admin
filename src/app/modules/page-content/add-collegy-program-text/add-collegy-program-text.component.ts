...
@Component({
  selector: 'app-add-collegy-program-text',
  templateUrl: './add-collegy-program-text.component.html',
  styleUrls: ['./add-collegy-program-text.component.css']
})
export class AddCollegyProgramTextComponent implements OnInit {
  ...
  patchForm(pageContent) {
    ...
    this.pageContentForm.patchValue({
      ...
      program_content: pageContent?.program_content,
      button_text: pageContent?.button_text,
      button_link: pageContent?.button_link,
    });
    ...
    this.pageContentForm = this.fb.group(
      {
        ...
        program_content: ["", [Validators.required]],
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.pageContentForm.valid) {
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'program_content_section';
