...
@Component({
  selector: 'app-add-home-second-sec',
  templateUrl: './add-home-second-sec.component.html',
  styleUrls: ['./add-home-second-sec.component.css']
})
export class AddHomeSecondSecComponent implements OnInit {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.pageContentForm.valid) {
        ...
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'home_section_02';
