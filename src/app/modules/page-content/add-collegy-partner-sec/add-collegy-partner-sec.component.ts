...
@Component({
  selector: 'app-add-collegy-partner-sec',
  templateUrl: './add-collegy-partner-sec.component.html',
  styleUrls: ['./add-collegy-partner-sec.component.css']
})
export class AddCollegyPartnerSecComponent implements OnInit {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.pageContentForm.valid) {
        ...
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'collegy_partner_sec';
