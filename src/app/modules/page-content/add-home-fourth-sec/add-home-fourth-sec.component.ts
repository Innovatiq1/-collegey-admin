...
@Component({
  selector: 'app-add-home-fourth-sec',
  templateUrl: './add-home-fourth-sec.component.html',
  styleUrls: ['./add-home-fourth-sec.component.css']
})
export class AddHomeFourthSecComponent implements OnInit {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.pageContentForm.valid) {
        ...
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'home_section_04';
