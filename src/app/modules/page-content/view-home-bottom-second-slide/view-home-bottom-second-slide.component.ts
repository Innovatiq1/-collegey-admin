...
@Component({
  selector: 'app-view-home-bottom-second-slide',
  templateUrl: './view-home-bottom-second-slide.component.html',
  styleUrls: ['./view-home-bottom-second-slide.component.css']
})
export class ViewHomeBottomSecondSlideComponent implements OnInit {
  ...
  getHomeFirstSecData(filters) {
    ...
    this.pageContentService.getHomeFirstSecData(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.home_bottom_second_slide_data;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddHomeBottomSecondSlideComponent,
      nzFooter: [
        {
  ...
  deleteHome(index: any) {
    if (confirm("Are you sure to delete this item")) {
      ...
      var deletelist = { index: index, filedName: "home_bottom_second_slide_data" };
