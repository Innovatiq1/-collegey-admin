...
@Component({
  selector: 'app-view-collegy-program-text',
  templateUrl: './view-collegy-program-text.component.html',
  styleUrls: ['./view-collegy-program-text.component.css']
})
export class ViewCollegyProgramTextComponent implements OnInit {
  ...
  getHomeFirstSecData(filters) {
    ...
    this.pageContentService.getHomeFirstSecData(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.program_content_section;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddCollegyProgramTextComponent,
      nzFooter: [
        {
