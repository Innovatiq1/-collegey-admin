...
@Component({
  selector: 'app-add-home-first-section',
  templateUrl: './add-home-first-section.component.html',
  styleUrls: ['./add-home-first-section.component.css']
})
export class AddHomeFirstSectionComponent implements OnInit {
  ...
  patchForm(pageContent) {
    ...
    this.pageContentForm.patchValue({
      title: pageContent?.bannerText,
      midleTitle : pageContent?.midleTitle,
      subTitle: pageContent?.bannerSubText,
    ...
    this.pageContentForm = this.fb.group(
      {
        ...
        midleTitle: ["", [Validators.required]],
      },
    );
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.pageContentForm.valid) {
        ...
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'home_first_section';
