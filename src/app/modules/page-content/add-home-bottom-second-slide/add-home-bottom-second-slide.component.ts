...
@Component({
  selector: 'app-add-home-bottom-second-slide',
  templateUrl: './add-home-bottom-second-slide.component.html',
  styleUrls: ['./add-home-bottom-second-slide.component.css']
})
export class AddHomeBottomSecondSlideComponent implements OnInit {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      if (this.pageContentForm.valid) {
        ...
        if (this.mode === Mode.Create) {
          ...
          obj['insertaction'] = 'home_bottom_slide_02';
