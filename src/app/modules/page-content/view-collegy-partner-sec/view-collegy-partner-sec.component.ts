...
@Component({
  selector: 'app-view-collegy-partner-sec',
  templateUrl: './view-collegy-partner-sec.component.html',
  styleUrls: ['./view-collegy-partner-sec.component.css']
})
export class ViewCollegyPartnerSecComponent implements OnInit {
  ...
  getHomeFirstSecData(filters) {
    ...
    this.pageContentService.getHomeFirstSecData(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.partnerships_come_together;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      nzTitle: mode === "Create" ? "Create New Partnerships" : "Update Partnerships",
      nzContent: AddCollegyPartnerSecComponent,
      nzFooter: [
        {
  ...
  deleteHome(index: any) {
    if (confirm("Are you sure to delete this item")) {
      ...
      var deletelist = { index: index, filedName: "partnerships_come_together" };
