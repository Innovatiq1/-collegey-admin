...
@Component({
  selector: 'app-view-home-sixth-sec',
  templateUrl: './view-home-sixth-sec.component.html',
  styleUrls: ['./view-home-sixth-sec.component.css']
})
export class ViewHomeSixthSecComponent implements OnInit {
  ...
  getHomeFirstSecData(filters) {
    ...
    this.pageContentService.getHomeFirstSecData(filters).subscribe( response =>{
      ...
      this.assignData  = response?.data?.docs[0]?.home_sixth_sec_data;
  ...
  openModal(mode: Mode, id = null, item = null) {
    this.modal = this.modalService.create({
      ...
      nzContent: AddHomeSixthSecComponent,
      nzFooter: [
        {
